...
modelo = load_model('recursos/modelo-previsao-doenca-coracao')
...
st.header('Modelo de Previsão de Doença do Coração - Isabela Marinho')

st.divider()

st.write('Entre com as caracteristicas da pessoa:')
